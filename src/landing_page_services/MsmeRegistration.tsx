  ...
  const steps = [
    {
      icon: FileText,
      title: "Share Details",
      desc: "Enterprise & personal information"
    },
    {
      icon: Shield,
    ...
    {
      icon: CheckCircle,
      title: "Get Udyam Number",
      desc: "Receive certificate in 3-5 working days"
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-emerald-400">MSME Registration</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="text-right">
              <span className="text-lg font-bold text-emerald-400">Free</span>
              <p className="text-xs text-gray-500 line-through">₹599</p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed max-w-lg">
                ...
                Get your Udyam Registration Certificate in as little as 3 days.
              </p>
            </div>
        ...
        <Card className="bg-gradient-to-r from-teal-900/50 via-cyan-900/50 to-blue-900/50 border border-teal-500/20">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses who trusted RegiBIZ for their MSME registration.
            </p>
